...
export default function Jawan() {
  return (
    <div className="nav">
      ...
      <img className="im" src="src/assets/imgm/Jawan.jpg"/>
      <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/smP4vBPNuYQ?si=CuHXakpF6D6RFwir"
          ...
          ></iframe>
          <br /><br />
           <a href="/movies"><button type="submit">Back</button></a>
      </div>
    </div>
  );
}
